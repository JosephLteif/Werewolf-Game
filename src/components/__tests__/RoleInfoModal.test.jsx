...
describe('RoleInfoModal', () => {
  ...
  it('renders correctly for a specific role', () => {
    ...
    render(<RoleInfoModal selectedRoleId={ROLE_IDS.VILLAGER} onClose={onCloseMock} />);
  ...
  it('renders all available roles when showAllRoles is true', () => {
    const onCloseMock = vi.fn();
    render(<RoleInfoModal showAllRoles={true} onClose={onCloseMock} />);
