...
export function DayRevealScreen({ gameState, isHost, updateGame, myPlayer, now }) {
    return (
        <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 text-slate-900 flex flex-col items-center justify-center p-6 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                {isHost ? (
                    <button
                        onClick={() => updateGame({ phase: 'DAY_VOTE', votes: {}, lockedVotes: [], phaseEndTime: now + (gameState.settings.votingWaitTime * 1000) })}
